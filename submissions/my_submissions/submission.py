...
def scale_by_adaprop(
  ...
  def update_fn(updates, state, params):
    ...
    gain = jax.tree_util.tree_map(lambda g: g.astype(jnp.float16), gain)
...
def pmapped_train_step(workload,
  ...
  # current_param_container = jax.tree_util.tree_map(lambda g: g.astype(jnp.float32), current_param_container)
  return new_optimizer_state, current_param_container, new_model_state, loss, grad_norm
